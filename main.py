...
from funktionen import erfassen_speichern_studium, erfassen_speichern_lernsession, open_lernsessions
...
def study_erfassen(name_studium_erfassen_speichern=None):
    if request.method.lower() == "post":
        ...
        erfassen_speichern_studium(name_studium_erfassen_speichern,
                                   name_study_antwort,
...
def vorschlaege_ausgabe():
    if request.method.lower() == "post":
        ...
        return render_template("abfrage_lernsession.html", gespeicherte_lernsessions=open_lernsessions(), vorschlaege=vorschlaege)


def lernsessions_open():
    pass
...
def uebersicht():
    return render_template('uebersicht.html',
                        lernsessions = lernsessions_open()
